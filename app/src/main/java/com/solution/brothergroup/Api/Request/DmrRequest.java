...
public class DmrRequest {
    ...
    public DmrRequest(String topRows, int status, String apiid, String fromDate, String toDate, String transactionID, String accountNo,String childMobile, Boolean isExport, String userID, String sessionID, String session, String appid, String imei, String regKey, String version, String serialNo, String loginTypeID,boolean IsRecent) {
