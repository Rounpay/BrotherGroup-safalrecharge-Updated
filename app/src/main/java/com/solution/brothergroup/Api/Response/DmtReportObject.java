...
public class DmtReportObject {
    ...
    public void setOutletUserMobile(String outletUserMobile) {
        this.outletUserMobile = outletUserMobile;
    }
    ...
    public void setOutletUserCompany(String outletUserCompany) {
        this.outletUserCompany = outletUserCompany;
    }
