        ...
        if (v == create) {
            if (validationAddBeneficiary("") == 0) {
                ...
                if (UtilMethods.INSTANCE.isNetworkAvialable(this)) {
                    ...
                    loader.setCancelable(false);
                    loader.setCanceledOnTouchOutside(false);
                    UtilMethods.INSTANCE.AddBeneficiary(this, prefs.getString(ApplicationConstant.INSTANCE.senderNumberPref, ""), beneficiaryNumber.getText().toString().trim(), beneficiaryName.getText().toString().trim(), ifsc.getText().toString().trim(), accountNumber.getText().toString().trim(), bankName, bankId, loader, AddBeneficiary.this);
                } else {
                    UtilMethods.INSTANCE.NetworkError(this, getResources().getString(R.string.network_error_title),
                            getResources().getString(R.string.network_error_message));
                }
