...
public class MoveToBankReportAdapter extends RecyclerView.Adapter<MoveToBankReportAdapter.MyViewHolder> {
    ...
    public MoveToBankReportAdapter(ArrayList<MoveToWalletReportData> transactionsList, Activity mContext) {
    ...
    public void onBindViewHolder(final MoveToBankReportAdapter.MyViewHolder holder, int position) {
        ...
        // holder.amount.setText(UtilMethods.INSTANCE.formatedAmountWithRupees(operator.getAmount() + ""));
...
*/
        ...
        if (operator.getStatus() == 1) {
            ...
            holder.statusIcon.setImageResource(R.drawable.ic_pending_outline);
            ...
            holder.statusIcon.setImageResource(R.drawable.ic_check_mark_outline);
            ...
            holder.statusIcon.setImageResource(R.drawable.ic_cross_mark_outline);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            charges = (AppCompatTextView) view.findViewById(R.id.charges);
