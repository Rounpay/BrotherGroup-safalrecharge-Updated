...
public class PaynearActivity extends AppCompatActivity implements PaymentTransactionConstants, DeviceCommunicationMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isUsb = UtilMethods.INSTANCE.getPaynearUsb(this);
       ...
       /* radioCommGroup.setOnCheckedChangeListener((group, checkedId) -> {
        ...
        cashBtn.setOnClickListener(v -> {
            if (amount.getText().toString().length() == 0) {
                ...
                intent.putExtra("amount", UtilMethods.INSTANCE.getAmountFormat(amount.getText().toString()));
    ...
    void setCommDesign() {
        if (isUsb) {
          ...
          //  ImageViewCompat.setImageTintList(iconUsb, AppCompatResources.getColorStateList(this, R.color.colorPrimary));
            ...
            viewBluetooth.setBackgroundResource(R.drawable.rounded_grey_border);
          ...
          //  ImageViewCompat.setImageTintList(iconBluetooth, AppCompatResources.getColorStateList(this, R.color.colorAccent));
           ...
           // ImageViewCompat.setImageTintList(iconBluetooth, AppCompatResources.getColorStateList(this, R.color.colorPrimary));
            ...
            viewUSB.setBackgroundResource(R.drawable.rounded_grey_border);
        ...
        if (deviceType == DeviceType.N910 || deviceType == DeviceType.N3 /*|| deviceType == DeviceType.N6*/) {
            if (amount.getText().toString().length() == 0) {
                ...
                if (modeName.equalsIgnoreCase("emi")) {
                    ...
                    /*   intent.putExtra(DEVICE_COMMUNICATION_MODE, deviceCommMode);*/
                    intent.putExtra("amount", UtilMethods.INSTANCE.getAmountFormawitdot(amount.getText().toString()));
                    intent.putExtra("referanceno", (referanceno.getText().toString()));
                    intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                    startActivityForResult(intent, INTENT_NEXT_SCREEN);
                    ...
                    intent.putExtra("referanceno", (referanceno.getText().toString()));
                    intent.putExtra("amount", UtilMethods.INSTANCE.getAmountFormawitdot(amount.getText().toString()));
                    intent.putExtra("cashBackAmoumt", UtilMethods.INSTANCE.getAmountFormat(cashbacckamount.getText().toString()));
                    intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                    startActivityForResult(intent, INTENT_NEXT_SCREEN);
                }
            }
            ...
            if (amount.getText().toString().length() == 0) {
                ...
                if (modeName.equalsIgnoreCase("emi")) {
                    ...
                    intent.putExtra("referanceno", (referanceno.getText().toString()));
                    intent.putExtra("amount", UtilMethods.INSTANCE.getAmountFormawitdot(amount.getText().toString()));
                    intent.putExtra("cashBackAmount", UtilMethods.INSTANCE.getAmountFormat(cashbacckamount.getText().toString()));
                    intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                    startActivityForResult(intent, INTENT_NEXT_SCREEN);
                }
            }
    ...
    protected void onStart() {
        ...
        if (!isBlutoothEnableOpen) {
            ...
            if (mBluetoothAdapter == null) {
                new CustomAlertDialog(this,true).ErrorWithSingleBtnCallBack("Error", getString(R.string.bluetooth_not_supported_device), "Ok", false,
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == SUCCESS) {
               ...
               /* dropdownListMode.add("BalanceEnquiry");
                ...
                new CustomAlertDialog(PaynearActivity.this,true).ErrorWithSingleBtnCallBack("Failed", getString(R.string.no_payment_modes),
                        "Ok", false,
                        new CustomAlertDialog.DialogCallBack() {
                            @Override
                            public void onPositiveClick() {
                ...
                new CustomAlertDialog(PaynearActivity.this,true).ErrorWithSingleBtnCallBack("Error", getString(R.string.smething_went_wrong),
                        "Ok", false,
                        new CustomAlertDialog.DialogCallBack() {
                            @Override
                            public void onPositiveClick() {
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (isForSetting) {
                            ...
                            ActivityCompat.requestPermissions(PaynearActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_PERMISSIONS);
                        }
