...
public class PaymentTransactionActivity extends AppCompatActivity implements
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == QPOS_ID) {
                ...
                if (isActivityOpen) {
                    ...
                    new CustomAlertDialog(PaymentTransactionActivity.this,true).ErrorWithSingleBtnCallBack("Transaction Declined", "Transaction Status : " + iCCTransactionResponse.getResponseCode() + ":" + iCCTransactionResponse.getResponseMessage(), "Ok", false,
                ...
                if (paymentType.equalsIgnoreCase(EMI)) {
                    ...
                    if (isActivityOpen) {
                        new CustomAlertDialog(PaymentTransactionActivity.this,true).ErrorWithSingleBtnCallBack("Transaction Failed", "Transaction Status : " + iCCTransactionResponse.getResponseCode() + ":" + iCCTransactionResponse.getResponseMessage(), "Ok", false,
                                new CustomAlertDialog.DialogCallBack() {
                                    @Override
                                    public void onPositiveClick() {
                                       /* Intent i = new Intent(PaymentTransactionActivity.this, TransactionDetailsActivity.class);
                ...
                if (isActivityOpen) {
                    new CustomAlertDialog(PaymentTransactionActivity.this,true).WarningWithSingleBtnCallBack("Pending Status",
                            (String) msg.obj, "Ok",
                            false,
                            new CustomAlertDialog.DialogCallBack() {
                                @Override
                ...
                if (isActivityOpen) {
                    new CustomAlertDialog(PaymentTransactionActivity.this,true).SuccessfulWithCallBack("Success Status", (String) msg.obj, "Ok",
                            false,
                            new CustomAlertDialog.DialogCallBack() {
                                @Override
                                public void onPositiveClick() {
    ...
    public void alertMessage(String message) {
        if (isActivityOpen) {
            new CustomAlertDialog(PaymentTransactionActivity.this,true).WarningWithSingleBtnCallBack("Alert", message, "Ok", false,
                    new CustomAlertDialog.DialogCallBack() {
                        @Override
                        public void onPositiveClick() {
                            finish();
    ...
    public void alertMessageError(String title, String message) {
        if (isActivityOpen) {
            new CustomAlertDialog(PaymentTransactionActivity.this,true).ErrorWithSingleBtnCallBack(title, message, "Ok", false,
                    new CustomAlertDialog.DialogCallBack() {
                        @Override
                        public void onPositiveClick() {
                            finish();
    ...
    public void isDeviceON(String message) {
        ...
        if (isActivityOpen) {
            new CustomAlertDialog(PaymentTransactionActivity.this,true).WarningWithCallBack(message, "Alert", "Ok", false,
                    new CustomAlertDialog.DialogCallBack() {
                        @Override
                        public void onPositiveClick() {
    ...
    public void onBackPressed() {
        ...
        new CustomAlertDialog(PaymentTransactionActivity.this,true).WarningWithCallBack("Are you sure, you want to go back from this screen?", "Close Screen", "Back", true, new CustomAlertDialog.DialogCallBack() {
            @Override
            public void onPositiveClick() {
                finish();
            }
