...
public class FosReportActivity extends AppCompatActivity {
    ...
    void findViews() {
        ...
        fosCollectionReportAdapter = new FOSChannelReportAdapter(filterFromDate, filterToDate,
                transactionsObjects, loader, loginPrefResponse, this, new FOSChannelReportAdapter.FundTransferCallBAck() {
            @Override
