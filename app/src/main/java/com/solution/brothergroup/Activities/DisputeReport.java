...
import com.solution.brothergroup.Adapter.DisputeReportAdapter;
...
public class DisputeReport extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Complaint Report");
    ...
    private void HitApi() {
        if (UtilMethods.INSTANCE.isNetworkAvialable(this)) {
            ...
            UtilMethods.INSTANCE.RefundLog(this, filterTopValue, filterChooseCriteriaId, filterChooseCriteria, filterStatusId, filterFromDate, filterToDate, filteDateTypeId, filterEnterCriteria, loader);
