...
import com.solution.brothergroup.DMTWithPipe.ui.BeneficiaryListScreenNew;
import com.solution.brothergroup.DMTWithPipe.ui.MoneyTransferNew;
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (UtilMethods.INSTANCE.isNetworkAvialable(activity)) {
                    ...
                    UtilsMethodDMTPipe.INSTANCE.DeletebeneficiaryNew(activity, oid, sid, "", senderNumber1, id, loader, new UtilsMethodDMTPipe.ApiCallBack() {
                        @Override
