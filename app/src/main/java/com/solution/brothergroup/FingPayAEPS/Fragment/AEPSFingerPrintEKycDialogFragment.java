package com.solution.brothergroup.FingPayAEPS.Fragment;
...
public class AEPSFingerPrintEKycDialogFragment extends DialogFragment {
    ...
    void fetchDetaill() {
        ...
        if (selectedDevicePos == 0) {
            ...
            clickView.setVisibility(View.GONE);
            loaderView.setVisibility(View.VISIBLE);
            String pidData = "<?xml version=\"1.0\"?> <PidOptions ver=\"1.0\"> <Opts fCount=\"1\" fType=\"2\" iCount=\"0\" pCount=\"0\" format=\"0\" pidVer=\"2.0\" timeout=\"10000\" otp=\"\"  posh=\"UNKNOWN\" env=\"P\" /> <CustOpts><Param name=\"marphokey\" value=\"\" /></CustOpts> </PidOptions>";
        ...
        try {
            if (paramString != null && !paramString.isEmpty() && paramString.contains("<PidData>")) {
                ...
                if (mResp.getErrCode().equalsIgnoreCase("0") && paramString.contains("<Hmac>")) {
                    ...
                    UtilMethods.INSTANCE.CallOnboarding(contextCOB, bioAuthTypeCOB,true, fragmentManagerCOB, oIdCOB,
                            "", otpRefIDCOB, paramString, false, false,
                            false, null,
                            null, null, mProgressDialogCOB, LoginDataResponseCOB,UtilMethods.INSTANCE.getLattitude + "", UtilMethods.INSTANCE.getLongitude + "",
                           mApiCallBackCOB);
                } else {
                    errorTv.setVisibility(View.VISIBLE);
    ...
    public void setOnBoardingData(final Activity context,String msg, FragmentManager fragmentManager,int bioAuthType, int oid,
                                  String otpRefID, CustomLoader mProgressDialog,
                                  LoginResponse LoginDataResponse,
                                   UtilMethods.ApiCallBackOnBoardingMethod mApiCallBack) {
