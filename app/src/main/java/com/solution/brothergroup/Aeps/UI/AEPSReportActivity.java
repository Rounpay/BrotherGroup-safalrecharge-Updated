...
public class AEPSReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fromDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(AEPSReportActivity.this, date, myCalendar
        ...
        toDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(AEPSReportActivity.this, dateTo, myCalendarTo
    ...
    public void HitApi() {
        if (UtilMethods.INSTANCE.isNetworkAvialable(this)) {
            ...
            UtilMethods.INSTANCE.AEPSReport(this,  "0", filterTopValue + "", filterStatusId , filterFromDate, filterToDate, filterTransactionId , filterAccountNo, filterChildMobileNo,"false", isRecent, loader, new UtilMethods.ApiCallBack() {
                @Override
    ...
    public void dataParse( RechargeReportResponse mRechargeReportResponse) {
        ...
        transactionsObjects = transactions.getAePsDetail();

        if (transactionsObjects!=null && transactionsObjects.size() > 0) {
            noData.setVisibility(View.GONE);
            recycler_view.setVisibility(View.VISIBLE);
            mAdapter = new RechargeReportAdapter(transactionsObjects, this, false, mLoginDataResponse.getData().getRoleID());
