...
import static com.safalrecharges.image.cropper.CropImage.CAMERA_CAPTURE_PERMISSIONS_REQUEST_CODE;
import static com.safalrecharges.image.cropper.CropImage.PICK_IMAGE_CHOOSER_REQUEST_CODE;
import static com.safalrecharges.image.cropper.CropImage.getGalleryIntents;
...
import com.safalrecharges.image.cropper.CropImage;
import com.safalrecharges.image.cropper.CropImageView;
...
public class ImagePicker implements ImagePickerContract {
    ...
    public void openCamera() {
        if (needToAskPermissions()) {
            ...
            if (takePictureIntent.resolveActivity(activity.getPackageManager()) != null) {
                if(fragment!=null){
                    fragment.startActivityForResult(cameraIntent, PICK_IMAGE_CHOOSER_REQUEST_CODE);
    ...
    private Intent getCameraIntent() {
        ...
        String s = ".smart-image-picker-provider";
        String authority = activity.getPackageName() + s;
